...
$('.ec_calculator_gen').find("input[type = 'text']").focusout(function() {$("#dynErrDisp").html("");$("#dynErrDisp").hide();var buttonValue = $('.ec_calculator_gen').find("input[type = 'button']").val();if (buttonValue == "Calculate" || buttonValue == "calculate" || buttonValue == "Convert" || buttonValue == "Result"){
